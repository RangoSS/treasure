...
// querying the categories of product from the database and displaying it on  bar 
...
// query to display the product randomly from the database to the index page 
...
// display of the product category clicked on the sidebar 
