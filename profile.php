...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>        <!--home link-->
                        ...
                        <li><a href="#" id ="cart_container" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a>
                            ...
                            <ul class="dropdown-menu" style="width:400px;">
                                ...
                                <div class="panel-footer"><p style="text-align: center;">&copy; 2107 SpaceDiver .</p></div>
                            </ul>
                        </li>
        ...
        <div class="row footer">
            <div class="container">
                <p><a href="index.php">SpaceDiver</a> &copy; Copyright 2017. All Rights Reserved.</p>
            </div>
        </div>
